...
// Make ejs function renderFile available with asnyc await
const renderFile = promisify(ejs.renderFile).bind(ejs);

// Handle text & emoji chat chat
let addNewTextEmoji = async (req, res) => {
    ...
    try {
        ...
        let newMessage = await message.textAndEmojiChat(sender, receiverId, messageVal, isChatGroup);
