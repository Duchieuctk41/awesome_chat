    ...
    $(".user-add-new-contact").bind("click", function() {
        ...
        $.post("/contact/add-new", {uid: targetId}, function(data) {
            if(data.success) {
                ...
                increaseNumberNotifContact("count-request-contact-sent"); // js/calculateNotifiContact.js

                // Add at the modal tab ask add friends.
...
socket.on("response-add-new-contact", function(user) {
    ...
    // Add at the modal tab waiting for confirm
    let userInfoHtml =`
...
removeRequestContactSentReceived(); // js/removeRequestContactSentReceived.js
});
