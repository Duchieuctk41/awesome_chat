    ...
    $(`#image-chat-${divId}`).unbind("change").on("change", function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $(`.person[data-chat=${divId}]`).find("span.preview").removeClass("message-time-realtime").html("Hình ảnh...");
...
$(document).ready(function() {
    socket.on("response-chat-image", function(response) {
        ...
        $(`.person[data-chat=${divId}]`).find("span.preview").addClass("message-time-realtime").html("Hình ảnh...");
