        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.success) {
                    ...
                    increaseNumberNotifContact("count-contacts"); // js/calculateNotifiContact.js
...
socket.on("response-approve-request-contact-received", function(user) {  
    ...
    decreaseNumberNotifContact("count-request-contact-sent"); // js/calculateNotifiContact.js
    increaseNumberNotifContact("count-contacts"); // js/calculateNotifiContact.js
